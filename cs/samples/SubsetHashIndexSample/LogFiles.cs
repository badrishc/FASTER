...
namespace SubsetHashIndexSample
{
    class LogFiles
    {
        ...
        internal LogFiles(int numGroups)
        {
            ...
            if (SubsetHashIndexSampleApp.useObjectValues)
            ...
            this.LogSettings = new LogSettings 
            {
                ...
                CopyReadsToTail = SubsetHashIndexSampleApp.copyReadsToTail,
                ReadCacheSettings = SubsetHashIndexSampleApp.useReadCache ? new ReadCacheSettings { MemorySizeBits = MemorySizeBits, PageSizeBits = PageSizeBits } : null
            };
