...
{
    /// <summary>
    /// A session for SubsetIndex operations.
    /// </summary>
    public class ClientSessionSI<TProviderData, TRecordId> : IDisposable where TRecordId : struct, IComparable<TRecordId>
    {
        private readonly SubsetIndex<TProviderData, TRecordId> subsetIndex;
        ...
        internal ClientSessionSI(SubsetIndex<TProviderData, TRecordId> subsetIndex, long id)
        {
        ...
        public Status Upsert(TProviderData data, TRecordId recordId, ChangeTracker<TProviderData, TRecordId> changeTracker)
            => this.subsetIndex.Upsert(this, data, recordId, changeTracker);
        ...
        public Status Update(ChangeTracker<TProviderData, TRecordId> changeTracker)
            => this.subsetIndex.Update(this, changeTracker);
        ...
        public ValueTask UpdateAsync(ChangeTracker<TProviderData, TRecordId> changeTracker, CancellationToken cancellationToken)
            => this.subsetIndex.UpdateAsync(this, changeTracker, cancellationToken);
        ...
        public Status Delete(ChangeTracker<TProviderData, TRecordId> changeTracker)
            => this.subsetIndex.Delete(this, changeTracker);
        ...
        public ValueTask DeleteAsync(ChangeTracker<TProviderData, TRecordId> changeTracker, CancellationToken cancellationToken)
            => this.subsetIndex.DeleteAsync(this, changeTracker, cancellationToken);

        #endregion SubsetIndex Updates
        ...
        public bool CompletePending(bool spinWait = false, bool spinWaitForCommit = false)
            => this.subsetIndex.CompletePending(this, spinWait, spinWaitForCommit);
        ...
        public ValueTask CompletePendingAsync(bool waitForCommit = false, CancellationToken cancellationToken = default)
            => this.subsetIndex.CompletePendingAsync(this, waitForCommit, cancellationToken);
        ...
        public ValueTask ReadyToCompletePendingAsync(CancellationToken cancellationToken = default)
            => this.subsetIndex.ReadyToCompletePendingAsync(this, cancellationToken);
        ...
        public ValueTask WaitForCommitAsync(CancellationToken cancellationToken = default)
            => this.subsetIndex.WaitForCommitAsync(this, cancellationToken);
        ...
        public IEnumerable<TRecordId> Query<TPKey>(IPredicate pred, TPKey key, QuerySettings querySettings = null)
            where TPKey : struct
            => this.subsetIndex.Query(this, pred, key, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey>(IPredicate pred, TPKey key, QuerySettings querySettings = null)
            where TPKey : struct
            => this.subsetIndex.QueryAsync(this, pred, key, querySettings);
#endif // NETSTANDARD21
        ...
        public IEnumerable<TRecordId> Query<TPKey>(IPredicate pred, IEnumerable<TPKey> keys, QuerySettings querySettings = null)
            where TPKey : struct
            => this.subsetIndex.Query(this, pred, keys, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey>(IPredicate pred, IEnumerable<TPKey> keys, QuerySettings querySettings = null)
            where TPKey : struct
            => this.subsetIndex.QueryAsync(this, pred, keys, querySettings);
        ...
        public IEnumerable<TRecordId> Query<TPKey1, TPKey2>(
            ...
            where TPKey1 : struct
            where TPKey2 : struct
            => this.subsetIndex.Query(this, pred1, key1, pred2, key2, matchPredicate, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey1, TPKey2>(
            ...
            where TPKey1 : struct
            where TPKey2 : struct
            => this.subsetIndex.QueryAsync(this, pred1, key1, pred2, key2, matchPredicate, querySettings);
        ...
        public IEnumerable<TRecordId> Query<TPKey1, TPKey2>(
            ...
            where TPKey1 : struct
            where TPKey2 : struct 
            => this.subsetIndex.Query(this, pred1, keys1, pred2, keys2, matchPredicate,querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey1, TPKey2>(
            ...
            where TPKey1 : struct
            where TPKey2 : struct
            => this.subsetIndex.QueryAsync(this, pred1, keys1, pred2, keys2, matchPredicate,querySettings);
#endif // NETSTANDARD21
        ...
        public IEnumerable<TRecordId> Query<TPKey1, TPKey2, TPKey3>(
            ...
            where TPKey2 : struct
            where TPKey3 : struct 
            => this.subsetIndex.Query(this, pred1, key1, pred2, key2, pred3, key3, matchPredicate, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey1, TPKey2, TPKey3>(
            ...
            where TPKey2 : struct
            where TPKey3 : struct
            => this.subsetIndex.QueryAsync(this, pred1, key1, pred2, key2, pred3, key3, matchPredicate, querySettings);
#endif // NETSTANDARD21
        ...
        public IEnumerable<TRecordId> Query<TPKey1, TPKey2, TPKey3>(
            ...
            where TPKey2 : struct
            where TPKey3 : struct 
            => this.subsetIndex.Query(this, pred1, keys1, pred2, keys2, pred3, keys3, matchPredicate, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey1, TPKey2, TPKey3>(
            ...
            where TPKey2 : struct
            where TPKey3 : struct
            => this.subsetIndex.QueryAsync(this, pred1, keys1, pred2, keys2, pred3, keys3, matchPredicate, querySettings);
#endif // NETSTANDARD21
        ...
        public IEnumerable<TRecordId> Query<TPKey>(
                    ...
                    QuerySettings querySettings = null)
            where TPKey : struct 
            => this.subsetIndex.Query(this, predAndKeys, matchPredicate, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey>(
                    ...
                    QuerySettings querySettings = null)
            where TPKey : struct
            => this.subsetIndex.QueryAsync(this, predAndKeys, matchPredicate, querySettings);
#endif // NETSTANDARD21
        ...
        public IEnumerable<TRecordId> Query<TPKey1, TPKey2>(
            ...
            where TPKey1 : struct
            where TPKey2 : struct 
            => this.subsetIndex.Query(this, predAndKeys1, predAndKeys2, matchPredicate, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey1, TPKey2>(
            ...
            where TPKey1 : struct
            where TPKey2 : struct
            => this.subsetIndex.QueryAsync(this, predAndKeys1, predAndKeys2, matchPredicate, querySettings);
#endif // NETSTANDARD21
        ...
        public IEnumerable<TRecordId> Query<TPKey1, TPKey2, TPKey3>(
            ...
            where TPKey2 : struct
            where TPKey3 : struct 
            => this.subsetIndex.Query(this, predAndKeys1, predAndKeys2, predAndKeys3, matchPredicate, querySettings);
        ...
        public IAsyncEnumerable<TRecordId> QueryAsync<TPKey1, TPKey2, TPKey3>(
            ...
            where TPKey2 : struct
            where TPKey3 : struct
            => this.subsetIndex.QueryAsync(this, predAndKeys1, predAndKeys2, predAndKeys3, matchPredicate, querySettings);
#endif // NETSTANDARD21
