...
namespace FASTER.indexes.SubsetHashIndex
{
        ...
        where UserFunctions : IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>
    {
        ...
        private void SetBeforeData(ref TKVKey key, ref TKVValue value, long logicalAddress, bool isIpu)
        {
            ...
            this.ChangeTracker ??= this.subsetHashIndex.CreateChangeTracker();
            this.subsetHashIndex.SetBeforeData(this.ChangeTracker, CreateProviderData(ref key, ref value), logicalAddress, isIpu && this.recordAccessor.ValueHasObjects());
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void SetAfterData(ref TKVKey key, ref TKVValue value, long logicalAddress)
            => this.subsetHashIndex.SetAfterData(this.ChangeTracker, CreateProviderData(ref key, ref value), logicalAddress);
