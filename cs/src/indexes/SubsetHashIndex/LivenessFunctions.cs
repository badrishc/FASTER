...
namespace FASTER.indexes.SubsetHashIndex
{
                                                                            ...
                                                                            LivenessFunctions<TKVKey, TKVValue>.Output, LivenessFunctions<TKVKey, TKVValue>.Context>
    {
        ...
        public virtual bool ConcurrentWriter(ref TKVKey key, ref TKVValue src, ref TKVValue dst, long logicalAddress) => throw new InternalErrorExceptionSHI(errorMsg);

        public virtual void InitialUpdater(ref TKVKey key, ref Input input, ref TKVValue value, long logicalAddress) => throw new InternalErrorExceptionSHI(errorMsg);
        public virtual bool NeedCopyUpdate(ref TKVKey key, ref Input input, ref TKVValue value) => throw new InternalErrorExceptionSHI(errorMsg);
        public virtual void CopyUpdater(ref TKVKey key, ref Input input, ref TKVValue oldValue, ref TKVValue newValue, long oldLogicalAddress, long newLogicalAddress) => throw new InternalErrorExceptionSHI(errorMsg);
        public virtual bool InPlaceUpdater(ref TKVKey key, ref Input input, ref TKVValue value, long logicalAddress) => throw new InternalErrorExceptionSHI(errorMsg);

        public virtual void RMWCompletionCallback(ref TKVKey key, ref Input input, Context ctx, Status status) => throw new InternalErrorExceptionSHI(errorMsg);
        public virtual void UpsertCompletionCallback(ref TKVKey key, ref TKVValue value, Context ctx) => throw new InternalErrorExceptionSHI(errorMsg);
        public virtual void DeleteCompletionCallback(ref TKVKey key, Context ctx) => throw new InternalErrorExceptionSHI(errorMsg);
        public virtual void CheckpointCompletionCallback(string sessionId, CommitPoint commitPoint) => throw new InternalErrorExceptionSHI(errorMsg);
