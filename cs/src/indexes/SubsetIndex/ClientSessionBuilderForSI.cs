...
namespace FASTER.indexes.SubsetIndex
{
    ...
    /// </summary>
    public struct ClientSessionBuilderForSI<TKVKey, TKVValue, Input, Output, Context>
    {
        ...
        internal ClientSessionBuilderForSI(FasterKVForSI<TKVKey, TKVValue> fkvSi, IFunctions<TKVKey, TKVValue, Input, Output, Context> functions)
        {
            this.fkvSi = fkvSi;
        ...
        public ClientSessionForSI<TKVKey, TKVValue, Input, Output, Context, IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>> NewSession<Functions>(
        ...
        {
            return fkvSi.InternalNewSessionForSI<Input, Output, Context, IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>>(
        ...
        /// <param name="sessionVariableLengthStructSettings">Session-specific variable-length struct settings</param>
        /// <returns>Session instance</returns>
        public ClientSessionForSI<TKVKey, TKVValue, Input, Output, Context, IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>> ResumeSession<Functions>(
            ...
            where Functions : IFunctions<TKVKey, TKVValue, Input, Output, Context>
        {
            return fkvSi.InternalResumeSessionForSI<Input, Output, Context, IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>>(
        ...
        /// <param name="sessionVariableLengthStructSettings">Session-specific variable-length struct settings</param>
        /// <returns>Session instance</returns>
        public ClientSessionForSI<TKVKey, TKVValue, Input, Output, Context, IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>> NewSession<Functions>(string sessionId = null, 
                bool threadAffinitized = false, SessionVariableLengthStructSettings<TKVValue, Input> sessionVariableLengthStructSettings = null)
            where Functions : IFunctions<TKVKey, TKVValue, Input, Output, Context>
        {
        ...
        /// <param name="sessionVariableLengthStructSettings">Session-specific variable-length struct settings</param>
        /// <returns>Session instance</returns>
        public ClientSessionForSI<TKVKey, TKVValue, Input, Output, Context, IAdvancedFunctions<TKVKey, TKVValue, Input, Output, Context>> ResumeSession<Functions>(string sessionId, 
